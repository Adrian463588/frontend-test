...
const IssuedPage: React.FC = () => {
  ...
  const issuedBooks = [
    { id: 1, cover: 'url-to-book-cover', title: 'Bumi', returnDate: '09/09/2023' },
    { id: 2, cover: 'url-to-book-cover', title: 'Bintang', returnDate: '09/09/2023' },
    { id: 3, cover: 'url-to-book-cover', title: 'Bulan', returnDate: '09/09/2023' },
  ];
